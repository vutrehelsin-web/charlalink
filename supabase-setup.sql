...
-- ============================================
-- INSTRUCCIONES:
-- 1. Ejecuta este SQL en el Editor SQL de Supabase
-- 2. Ve a Storage → New Bucket → Nombre: chat-media, Public: Sí
-- 3. El chat funcionará con almacenamiento en la nube
-- ============================================
